        ...
        >
          <motion.div className={styles.content} variants={containerVariants}>
            ...
            <motion.p variants={itemVariants}>
              {/* Business consultancy enables companies to stay competitive in a rapidly evolving<br />
              digital landscape, ultimately leading to increased efficiency */}
              At Dadisha, we power 22 industries with smart, compliant, and future-ready QHSE solutions.
          ...
          >
            ...
            <motion.a
              ...
              whileHover="hover"
            >
              <Contact size={16} className={styles.icon} /> CONTACT
